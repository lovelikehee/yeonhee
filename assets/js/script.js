$(function (e) {
  ...
  $(window).scroll(function () {
    ...
    $(".fill-screen-bg").css({
      transform: "matrix( 1, 0, 0, 1 ,0," + -offset5 * 1.1 + ")",
    });
    ...
    $(".gallery-img-all").css({
      transform: "translateY(" + -(offset1 - 60) + "px)",
    });
    $(".work-typography").css({
      transform: "translateY(" + -(offset1 - 50) + "px)",
    });

    $(".contact-wrap").css({
      transform: "translateY(" + -offset6 * 1.4 + "px)",
    });
  ...
  $(".next").click(function () {
    ...
    item.eq(idx - 1).animate(
      {
        "margin-left": "-110%",
      },
      300
    );
    $(".current li").eq(idx).animate(
      {
        "margin-top": 0,
      },
      300
